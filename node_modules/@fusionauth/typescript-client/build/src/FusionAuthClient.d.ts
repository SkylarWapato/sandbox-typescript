...
export declare enum OAuthErrorReason {
    ...
    invalid_origin = 9,
    invalid_origin_opaque = 10,
    invalid_pkce_code_verifier = 11,
    invalid_pkce_code_challenge = 12,
    invalid_pkce_code_challenge_method = 13,
    invalid_redirect_uri = 14,
    invalid_response_mode = 15,
    invalid_response_type = 16,
    invalid_id_token_hint = 17,
    invalid_post_logout_redirect_uri = 18,
    invalid_device_code = 19,
    invalid_user_code = 20,
    invalid_additional_client_id = 21,
    grant_type_disabled = 22,
    missing_client_id = 23,
    missing_code = 24,
    missing_device_code = 25,
    missing_grant_type = 26,
    missing_redirect_uri = 27,
    missing_refresh_token = 28,
    missing_response_type = 29,
    missing_token = 30,
    missing_user_code = 31,
    missing_verification_uri = 32,
    login_prevented = 33,
    user_code_expired = 34,
    user_expired = 35,
    user_locked = 36,
    user_not_found = 37,
    client_authentication_missing = 38,
    invalid_client_authentication_scheme = 39,
    invalid_client_authentication = 40,
    client_id_mismatch = 41,
    change_password_administrative = 42,
    change_password_breached = 43,
    change_password_expired = 44,
    change_password_validation = 45,
    unknown = 46
}
