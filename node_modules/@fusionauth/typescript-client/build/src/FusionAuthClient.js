...
(function (BreachAction) {
    BreachAction[BreachAction["Off"] = 0] = "Off";
    BreachAction[BreachAction["RecordOnly"] = 1] = "RecordOnly";
    BreachAction[BreachAction["NotifyUser"] = 2] = "NotifyUser";
    BreachAction[BreachAction["RequireChange"] = 3] = "RequireChange";
...
(function (BreachedPasswordStatus) {
    BreachedPasswordStatus[BreachedPasswordStatus["None"] = 0] = "None";
    BreachedPasswordStatus[BreachedPasswordStatus["ExactMatch"] = 1] = "ExactMatch";
    BreachedPasswordStatus[BreachedPasswordStatus["SubAddressMatch"] = 2] = "SubAddressMatch";
    BreachedPasswordStatus[BreachedPasswordStatus["PasswordOnly"] = 3] = "PasswordOnly";
    BreachedPasswordStatus[BreachedPasswordStatus["CommonPassword"] = 4] = "CommonPassword";
})(BreachedPasswordStatus = exports.BreachedPasswordStatus || (exports.BreachedPasswordStatus = {}));
var BreachMatchMode;
(function (BreachMatchMode) {
    BreachMatchMode[BreachMatchMode["Low"] = 0] = "Low";
    BreachMatchMode[BreachMatchMode["Medium"] = 1] = "Medium";
    BreachMatchMode[BreachMatchMode["High"] = 2] = "High";
...
(function (ChangePasswordReason) {
    ChangePasswordReason[ChangePasswordReason["Administrative"] = 0] = "Administrative";
    ChangePasswordReason[ChangePasswordReason["Breached"] = 1] = "Breached";
    ChangePasswordReason[ChangePasswordReason["Expired"] = 2] = "Expired";
    ChangePasswordReason[ChangePasswordReason["Validation"] = 3] = "Validation";
...
(function (ClientAuthenticationMethod) {
    ClientAuthenticationMethod[ClientAuthenticationMethod["none"] = 0] = "none";
    ClientAuthenticationMethod[ClientAuthenticationMethod["client_secret_basic"] = 1] = "client_secret_basic";
    ClientAuthenticationMethod[ClientAuthenticationMethod["client_secret_post"] = 2] = "client_secret_post";
...
(function (OAuthErrorReason) {
    ...
    OAuthErrorReason[OAuthErrorReason["change_password_administrative"] = 42] = "change_password_administrative";
    OAuthErrorReason[OAuthErrorReason["change_password_breached"] = 43] = "change_password_breached";
    OAuthErrorReason[OAuthErrorReason["change_password_expired"] = 44] = "change_password_expired";
    OAuthErrorReason[OAuthErrorReason["change_password_validation"] = 45] = "change_password_validation";
    OAuthErrorReason[OAuthErrorReason["unknown"] = 46] = "unknown";
